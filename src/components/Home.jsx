  ...
  return (
    <section className='relative z-10 min-h-screen flex flex-col justify-center items-center px-4 md:px-8'>
        ...
        >
            ...
            <motion.div variants={textVariant} className='text-2xl md:text-3xl font-semibold mb-6 text-blue-400'>
                <TypeAnimation
                    sequence={[
            ...
            <motion.a 
                ...
                href="./resume.pdf" 
                target="_blank"
                className='px-8 py-3 bg-white text-gray-900 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-gray-200 hover:shadow-lg hover:scale-105'
            >
